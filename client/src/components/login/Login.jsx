...
<form className="form_container">
        ...
        <div className="input_container">
            ...
            <input placeholder="name@mail.com" title="Inpit title" name="email" type="text" className="input_field" id="email_field" onChange={change} value={Inputs.email} />
        </div>
        <div className="input_container">
            ...
            {/* </svg> */}
            <input placeholder="Password" title="Inpit title" name="password" type="password" className="input_field" id="password_field" onChange={change} value={Inputs.password} />
        </div>
        <button title="Sign In" type="submit" className="sign-in_btn" onClick={submit}>
            <span>Sign In</span>
        </button>
